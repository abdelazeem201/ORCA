...
set_output_delay -add_delay -min 1.0 -clock v_PCI_CLK $orca_ports(pci_outputs)
...
set_input_delay  -max 6.0 -clock ate_clk $orca_ports(mode_reset)
set_input_delay  -max 4.0 -clock ate_clk $orca_ports(test_si)
set_output_delay -max 4.0 -clock ate_clk $orca_ports(test_so)
